...
public class ImageAdjuster
{
    ...
    public ImageAdjuster(Context context)
    {
    ...
    */
        ...
        {  
            ...
            private final Handler handler = new Handler()
            {
                ...
                public void handleMessage(Message msg)
                {
                    ...
                    Log.v(Main.APP_IDENTIFIER, "done : " + imageFile);
                    imageFile = null;
	 ...
	 * @param isClear
	 */
	public void setIsClearBitmap(boolean isClear)
	{
		isClearBitmap = isClear;
	}
	 ...
	 * @return
	 */
    private static Bitmap getBitmapFromUri(Context context, Uri uri, int width, int height)
    {
     ...
     * @return ビットマップデータ
     */
    private static Bitmap getBitmap(String pictureString, int width, int height)
    {
