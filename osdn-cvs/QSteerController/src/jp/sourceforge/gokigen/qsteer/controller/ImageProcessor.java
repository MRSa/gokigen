...
import jp.sourceforge.gokigen.qsteer.controller.QSteerControlDrawer.IRedrawer;
...
public class ImageProcessor extends Thread implements ICameraDataReceiver, Runnable
{
	...
	private boolean processFrame(byte[] data)
	{
        ...
        targetBitmap.eraseColor(Color.argb(0, 0, 0, 0)); 
        {
        	...
        	targetCanvas.drawRect(10.0f, 200.0f, 90.0f, 230.0f, paint);
            paint.setColor(Color.BLUE);
            paint.setStyle(Paint.Style.STROKE);
            paint.setTextSize(12.0f);
            paint.setStrokeWidth(1.0f);
            targetCanvas.drawText("" + tick, 20.0f, 215.0f, paint);
            tick++;        
        }
