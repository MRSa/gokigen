 ...
 *
 */
public class MainListener implements OnClickListener, OnTouchListener, UsbAccessoryManagement.IAccessoryControl, QSteerControlDrawer.IRedrawer
{
    ...
    private UsbAccessoryManagement  accessoryManager = null;
    ...
    {
        parent = argument;
        accessoryManager = new UsbAccessoryManagement(argument, this);
        imageProcessor = new ImageProcessor(this);
        canvasDrawer = new QSteerControlDrawer(argument, this, accessoryManager, imageProcessor);
    ...
    {
    	accessoryManager.CheckAccessoryPermission();
    ...
    private void showPreference()
    {
        ...
        {
            // 設定画面を呼び出す
            Intent prefIntent = new Intent(parent,jp.sourceforge.gokigen.qsteer.controller.Preference.class);
            parent.startActivityForResult(prefIntent, 0);
        }
        catch (Exception e)
        {
    ...
    private void showControls()
    {
        ...
        boolean isSingleMode = false; // preferences.getBoolean("SingleControl", false);
