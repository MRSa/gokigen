...
import jp.osdn.gokigen.aira01b.olycamerawrapper.CameraDateTimeSynchronizer;
import jp.osdn.gokigen.aira01b.olycamerawrapper.ICameraDateTimeSynchronizer;

public class ImageGridViewFragment extends Fragment  implements AdapterView.OnItemSelectedListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener, MultiFileDownloadConfirmationDialog.Callback, ImageDownloader.Callback
{
    ...
    private ICameraDateTimeSynchronizer dateTimeSynchronizer = null;
    private OlyCameraContentListHolder contentListHolder = new OlyCameraContentListHolder();
    ...
    public void setCamera(OLYCamera camera) {
        this.camera = camera;
        dateTimeSynchronizer = new CameraDateTimeSynchronizer(getActivity(), camera);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        } else if (id == R.id.action_datetime_synchronize) {
            if (dateTimeSynchronizer != null) {
                Log.v(TAG, "synchronizeDatetime()");
                dateTimeSynchronizer.synchronizeDatetime(false);
            }
