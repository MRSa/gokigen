...
public class OlyCameraLiveViewOnTouchListener  implements View.OnClickListener, View.OnTouchListener
{
    ...
    public void prepareInterfaces(IOlyCameraCoordinator cameraCoordinator, IPhoneCameraShutter phoneShutter, IStatusViewDrawer statusDrawer, ILiveImageStatusNotify liveImageView)
    {
