...
public class MyInterfaceProvider implements IAirA01BInterfacesProvider
{
     ...
     *   コンストラクタ
     */
    public MyInterfaceProvider(Context context, ICameraStatusReceiver statusReceiver, IChangeScene changeScene)
    {
    ...
    public void setPropertyProvider(IOlyCameraPropertyProvider propertyProvider)
    {
