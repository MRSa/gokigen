...
public class PreferenceSynchronizer implements Runnable
{
    ...
    public PreferenceSynchronizer(IOlyCameraPropertyProvider propertyInterface, SharedPreferences preference, IPropertySynchronizeCallback callback)
    {
    ...
    public interface IPropertySynchronizeCallback
    {
