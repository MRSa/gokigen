...
public class LiveViewFragment extends Fragment implements IStatusViewDrawer, CameraPropertyBackupRestore.IPropertiesOperation
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            takePictureControl = new TakePictureControl(camera, cameraController);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        {
            viewOnTouchClickListener = new CameraViewOnTouchClickListenerImpl(this, cameraController, takePictureControl);
        }
