...
public class CameraController implements ITakePictureRequestedControl {
    ...
    public String getActualShutterSpeed()
    {
        ...
        try
        {
            String data[] = camera.decodeCameraPropertyValue(camera.getActualShutterSpeed());
            value = data[1];
        }
        catch (Exception e)
        {
    ...
    public String getActualApertureValue()
    {
        ...
        try
        {
            String data[] = camera.decodeCameraPropertyValue(camera.getActualApertureValue());
            value = data[1];
        }
        catch (Exception e)
        {
    ...
    public String getActualExposureCompensation()
    {
        ...
        try
        {
            String data[] = camera.decodeCameraPropertyValue(camera.getActualExposureCompensation());
            value = data[1];
        }
        catch (Exception e)
        {
