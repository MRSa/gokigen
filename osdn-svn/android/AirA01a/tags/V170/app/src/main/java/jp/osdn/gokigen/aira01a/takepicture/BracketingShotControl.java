...
public class BracketingShotControl implements OLYCamera.TakePictureCallback
{
    ...
    public static final int BRACKET_EXPREV = 1;     // 露出補正
    public static final int BRACKET_APERTURE = 2;   // 絞り
    public static final int BRACKET_ISO = 3;         // ISO
    public static final int BRACKET_SHUTTER = 4;    // シャッター
    public static final int BRACKET_WB = 5;          // ホワイトバランス
    public static final int BRACKET_COLOR_TONE = 6; // カラートーン
     ...
     */
    public BracketingShotControl(OLYCamera camera, ITakePictureRequestedControl control)
    {
     ...
     *
     */
    public void startShootBracketing()
    {
