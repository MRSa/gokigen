 ...
 */
public class LiveViewFragment extends Fragment implements IStatusViewDrawer, CameraPropertyBackupRestore.IPropertiesOperation
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            takePictureControl = new TakePictureControl(getContext(), camera, cameraController);
        }
...
*/
    ...
    {
        getActivity().findViewById(R.id.controlPanelLayout).setVisibility(View.INVISIBLE);
        getActivity().findViewById(R.id.showControlPanelTextView).setVisibility(View.VISIBLE);
    }

    public void showControlPanel()
    {
        getActivity().findViewById(R.id.controlPanelLayout).setVisibility(View.VISIBLE);
        getActivity().findViewById(R.id.showControlPanelTextView).setVisibility(View.INVISIBLE);
    }
     ...
     *
     */
    public void showSaveLoadMyCameraPropertyDialog()
    {
    ...
    public void updateInformationTextView()
    {
    ...
    {
        SettingFragment fragment = SettingFragment.newInstance(getActivity(), camera);
    ...
    private void prepareViewObjectHolders(View view)
    {
        ...
        aeModeTextView = (TextView) view.findViewById(R.id.aeModeTextView);
        ...
        showControlPanelTextView = (TextView) view.findViewById(R.id.showControlPanelTextView);
        hideControlPanelTextView = (TextView) view.findViewById(R.id.hideControlPanelTextView);
        whiteBalanceImageView = (ImageView) view.findViewById(R.id.whiteBalanceImageView);
        ...
        aeLockImageView = (ImageView) view.findViewById(R.id.aelockImageView);
        manualFocusImageView = (ImageView) view.findViewById(R.id.manualFocusImageView);
        saveLoadImageView = (ImageView) view.findViewById(R.id.saveLoadImageView);
        magnifyImageView = (ImageView) view.findViewById(R.id.magnifyImageView);
    }
                ...
                public void run()
                {
                    ...
                    activity.runOnUiThread(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            if (toast)
                            {
                                String storedMessage = getContext().getString(R.string.saved_my_props) + name;
