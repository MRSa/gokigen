...
public class SettingFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    private void updatePreferenceIcon(String preferenceKey, int arrayValueId, int arrayIconId)
    {
        try
        {
            Resources res = getResources();
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey)
    {
        ...
        //updatePreferenceIcon("color_creator_color", R.array.prop_color_creator_color_value, R.array.prop_color_creator_color_icon);
        //updatePreferenceIcon("color_phase", R.array.prop_part_color_phase_value, R.array.prop_part_color_phase_icon);
